-- ============================================================================
-- Migration 0004_operator_grants.down.sql — rollback of the operator_grants
...
-- were created in 0004 .up; they are dropped here because nothing else in the
...
DROP INDEX IF EXISTS uq_operator_grants_active_tuple;
