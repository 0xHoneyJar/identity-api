> **DEPRECATED BY RIDE (2026-07-19):** Retained as operator narrative. Agents should prefer `grimoires/loa/prd.md` (ride-grounded) + `reality/` for code truth. Do not delete this archive.
